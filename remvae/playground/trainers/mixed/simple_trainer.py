...
class MixedSimpleTrainer(Trainer):
    ...
    def train(self, dataset: Union[Dataset, DataLoader], **kwargs) -> Tuple[TextVAE, ImageVAE]:
        ...
        metrics = {'text_model_loss': [], 'image_model_loss': [], 'text_kd_loss': [], 'image_kd_loss': [], 'align_loss': [], 'kd_weight': []}
        ...
        for epoch in range(self.epochs):
            ...
            for iter, (image, sequence) in enumerate(dataset):
                ...
                text_model_loss, image_model_loss, text_kd_loss, image_kd_loss, align_loss = self.__loss_function(
                    output_text, 
                    target_sequence, 
                    mu_text, 
                    sigma_text, 
                ...
                loss = image_model_loss + 1e2 * text_model_loss + 10 * align_loss + image_kd_loss
    ...
    def __loss_function(self, 
        ...
        return text_model_loss, image_model_loss, text_kd_loss, image_kd_loss, align_loss
