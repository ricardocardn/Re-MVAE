...
class ImageAdaptativennealingTrainer(Trainer):
    ...
    def train(self, dataset: Union[Dataset, DataLoader], device, **kwargs) -> ImageVAE:
        results_dir = kwargs.get('results_dir', "")
        checkpoint_dir = kwargs.get('checkpoint_dir', "")
        checkpoint_steps = kwargs.get('checkpoint_steps', 0)
        return_metrics = kwargs.get('return_metrics', False)

        metrics = {'image_model_loss': [], 'image_kd_loss': [], 'weight': []}
        step = 0
        ...
        for epoch in range(self.epochs):
            ...
            for iter, image in enumerate(dataset):
                ...
                image_model_loss, image_kd_loss, weight = self.__loss_function(
                    output_image,
                    target_image,
                    mu,
                    sigma,
    ...
    def __loss_function(self, 
        ...
        return image_model_loss, image_kd_loss, weight
