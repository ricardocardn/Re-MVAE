...
def generate_visualize_script(args_path: str):
    ...
    template = env.get_template('generator/templates/visualize.py.jinja')
    ...
    output_path = os.path.join(output_dir, 'visualize.py')
